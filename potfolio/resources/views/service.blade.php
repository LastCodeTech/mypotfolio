...
<title>Sulaimon Abubakre - Services</title>
...
<div class="relative flex min-h-screen w-full flex-col bg-[#F8FAFC] group/design-root overflow-x-hidden">
<!-- Sticky Navigation -->

<main class="flex-grow">
<!-- Headline -->
<h1 class="text-[#1E293B] tracking-light text-[32px] font-bold leading-tight px-4 text-left pb-1 pt-8"></h1>
<div class="flex items-center bg-background-light dark:bg-background-dark p-4 pb-2 justify-between sticky top-0 z-10">
<h2 class="text-text-light dark:text-text-dark text-xl font-bold leading-tight tracking-[-0.015em] flex-1">My Services</h2>
</div>
<!-- Body Text -->
